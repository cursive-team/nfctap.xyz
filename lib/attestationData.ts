...
export function attestationText(sigmoji: Sigmoji): string | undefined {
  if (
  ...
  if (
    ...
    return "Attended FtC Berlin Demos";
  }
  ...
  if (
    ...
    sigmoji.PCD.claim.nonce < 17
  ) {
    return "Attended ZK Alpha Session";
  }
